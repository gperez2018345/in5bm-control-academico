...
-- -----------------------------------------------------
  ...
  values("2021001", "Gonzonalez", "Ricardo", "ricardo@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021002", "Perez", "Mariana", "mariana@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021003", "Juarez", "Camila", "camila@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021004", "Perez", "Fernando", "fernando@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021005", "Ponce", "Julieta", "julieta@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021006", "del Carmen", "Maria", "maria@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021007", "Estrada", "Antonio", "antonio@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021008", "Hernandez", "Jose", "jose@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021009", "Ordoñez", "Francisco", "francisco@gmail.com");
  INSERT INTO Alumno(carne, apellidos, nombres, email)
  values("2021010", "Sical", "Manuel", "manuel@gmail.com");
  ...
  -- Insersion de datos en la entidad Salon
   ...
   values (20 , "Salon para el uso del area tecnica de la carrera de informatica", "C-20");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (15 , "Salon para el uso del area tecnica de electricidad", "C-21");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (30 , "Salon para el uso del area tecnica de mecanica automotriz", "C-22");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (40 , "Salon para el uso del area academica del grado de 4rto perito", "C-23");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (40 , "Salon para el uso del area academica del grado de 4rto perito", "C-24");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (50 , "Salon para el uso del area academica del grado de 4rto perito", "C-25");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (25 , "Salon para el uso del area tecnica de dibujo", "C-26");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (20 , "Salon para el uso del area tecnica de informatica", "C-27");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (30 , "Salon para el uso del area academica del grado de 5to perito", "C-28");
   insert into Salon(capacidad , descripcion, nombre_salon) 
   values (40 , "Salon para el uso del area academica del grado de 6to perito", "C-29");
   select  * from Salon;
   
   -- Inserción de datos en la entidad: Carrera Tecnica
  
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0001-MECA-INDU","Técnico en mecánica industrial");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0002-SIST","Técnico en sistemas");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0003-AUTO","Técnico automotriz");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0004-MANT-INDU","Técnico en mantenimiento industrial");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0005-ELECTRI-INDU","Técnico en electricidad indutrial");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0006-ELME-INDU","Técnico electromecánica industrial");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0007-ELECTRO-INDU","Técnico en electrónica industrial");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0008-VEHIC-DIESE","Técnico en vehículos a diésel");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0009-MECATRO","Técnico en mecatrónica");
  insert into CarreraTecnica(codigo_carrera, nombre) 
  values("TEC-0010-REPA-SOPOR-SISTE","Técnico en reparación y soporte de sistemas");
